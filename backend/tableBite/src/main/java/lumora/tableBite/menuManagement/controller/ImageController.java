...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ApiResponse> saveImage(@RequestParam List<MultipartFile> files, @RequestParam Long foodId) {
        try {
            List<ImageDTO> savedImageDTOList = imageService.saveImage(files, foodId);
            return ResponseEntity.ok(new ApiResponse("uploaded successfully", savedImageDTOList));
        } catch (Exception e) {
